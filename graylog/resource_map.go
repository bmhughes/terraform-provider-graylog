...
import (
	...
	"github.com/bmhughes/terraform-provider-graylog/graylog/resource/dashboard/position"
	"github.com/bmhughes/terraform-provider-graylog/graylog/resource/dashboard/widget"
	"github.com/bmhughes/terraform-provider-graylog/graylog/resource/event/definition"
	"github.com/bmhughes/terraform-provider-graylog/graylog/resource/event/notification"
	"github.com/bmhughes/terraform-provider-graylog/graylog/resource/role"
	"github.com/bmhughes/terraform-provider-graylog/graylog/resource/sidecar"
	"github.com/bmhughes/terraform-provider-graylog/graylog/resource/sidecar/collector"
	"github.com/bmhughes/terraform-provider-graylog/graylog/resource/sidecar/configuration"
	...
	"github.com/bmhughes/terraform-provider-graylog/graylog/resource/system/pipeline/rule"
	"github.com/bmhughes/terraform-provider-graylog/graylog/resource/user"
